"""
    EXAMPLE 13
    This simulates a setup to jump higher than usual. Just requires 33 tick perfect inputs xd.
    It is very close to theoretical optimal.
    
    The strat is the following:
        2x normal jump bhops
        30x ctap bhops
        1x normal jump bhop
        1x crouched jump bhop
    ...
    The ctaps are used to be able to fit in one more normal jump bhop.

"""
    EXAMPLE 16
    This is an alternative strat to example 15. It is very similar.
    ...
    Especially if the strafe can be done using wall strafes.
    ...
    The trick is that the 3rd and 4th jump is slightly because of
    TF2's "bunnyjump prevention".
